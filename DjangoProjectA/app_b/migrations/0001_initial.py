# Generated by Django 3.0 on 2019-12-18 07:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=16, unique=True, verbose_name='编辑名称')),
            ],
            options={
                'db_table': 't_class',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=16, unique=True, verbose_name='课程名称')),
            ],
            options={
                'db_table': 't_course',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=8, unique=True, verbose_name='年级名称')),
            ],
            options={
                'db_table': 't_grade',
            },
        ...
        migrations.AddField(
            model_name='class',
            name='teacher_id',
            field=models.ManyToManyField(db_column='teacher_id', db_table='t_teach2cls', to='app_b.Teacher'),
        ),
